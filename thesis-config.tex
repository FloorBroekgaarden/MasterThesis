...
% ****************************************************************************************************
\newcommand{\myTitle}{On the search for Gravitational-Wave Progenitors:  Reducing the Computational costs of Binary Population Synthesis using Adaptive Importance Sampling\xspace}
\newcommand{\mySubtitle}{Master Thesis\xspace}
\newcommand{\myDegree}{Bachelor of Science (BSc.)\xspace}
\newcommand{\myName}{Floor Broekgaarden\xspace}
\newcommand{\myProf}{Put name here\xspace}
\newcommand{\myOtherProf}{Put name here\xspace}
\newcommand{\mySupervisor}{Selma E. de Mink\xspace}
...
\newcommand{\askselma}[1]{{\color{blue}#1}\xspace}
\newcommand{\QPOs}{\acp{QPO}\xspace}
\newcommand{\obsid}{ObsID}
\newcommand{\sw}[1]{\textsc{#1}}
%\newcommand{\bibname}{bibliography.bib}  % Floor 
...
\hypersetup{%
    ...
    pdfsubject={Gravitational Waves, importance sampling - binary stars evolution},%
    pdfkeywords={},%
    pdfcreator={Floor Broekgaarden},%
